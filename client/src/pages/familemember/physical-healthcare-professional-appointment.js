...
const PhysicalHealthcareProfessionalAppointment = () => {
  ...
  useEffect(() => {
    const fetchAppointmentInfo = async () => {
      ...
      try {
        ...
        // Get healthcare professionals by district for physical appointments
        const response = await elderApi.getHealthProfessionalsByElderDistrict(elderId);
        ...
        if (response.success) {
          ...
          if (counselor) {
            setCounselorInfo({
              ...
              fee: 2500, // Default fee for physical healthcare appointments
              license_number: counselor.license_number,
              current_institution: counselor.current_institution
            });
          } else {
            throw new Error('Healthcare professional not found in your district');
          }
  ...
  useEffect(() => {
    const fetchBlockedSlots = async () => {
      ...
      try {
        console.log('Fetching blocked slots for counselor:', counselorId, 'date:', selectedDate, 'type: physical');
        ...
        <div className={styles.appointmentContainer}>
          <div className={styles.headerSection}>
            ...
            <h1 className={styles.pageTitle}>
              📅 Book Physical Healthcare Consultation
            </h1>
            <p className={styles.pageSubtitle}>
              Schedule a home visit with {counselorInfo?.name}
            </p>
          </div>
          ...
          <div className={styles.infoCardsContainer}>
              ...
              <div className={styles.cardContent}>
                ...
                {counselorInfo ? (
                  <>
                    ...
                    <p>🏥 {counselorInfo.current_institution}</p>
                  </>
                ) : (
            ...
            <div className={styles.infoCard}>
              ...
              <div className={styles.cardContent}>
                ...
                <p><strong>Consultation Fee:</strong> Rs. {counselorInfo?.fee || 2500}</p>
              </div>
            </div>
          </div>
                  ...
                  <div className={styles.calendarContainer}>
                    ...
                    <div className={styles.calendarGrid}>
                      ...
                      <div className={styles.monthDays}>
                        {calendarDays.map(({ day, date, isToday, isPast, isWeekend, isAvailable }) => (
                          <button
                            key={day}
            ...
            <div className={styles.requirementsSection}>
              <h3 className={styles.requirementsTitle}>📋 Physical Consultation Requirements</h3>
              <div className={styles.requirementsList}>
                ...
                <div className={styles.requirementItem}>
                  <span className={styles.requirementIcon}>⏰</span>
                  <span>2-hour session duration</span>
                </div>
                <div className={styles.requirementItem}>
                  <span className={styles.requirementIcon}>📄</span>
                ...
                <div className={styles.requirementItem}>
                  <span className={styles.requirementIcon}>📍</span>
                  <span>Accurate home address</span>
                </div>
                <div className={styles.requirementItem}>
                  <span className={styles.requirementIcon}>👨‍👩‍👧‍👦</span>
                  <span>Family member present</span>
                </div>
              </div>
            </div>
            ...
            {selectedDate && selectedTime && (
              <div className={styles.appointmentSummary}>
                ...
                <div className={styles.summaryContent}>
                  ...
                  <p><strong>Fee:</strong> Rs. {counselorInfo?.fee || 2500}</p>
                </div>
              </div>
            )}
...
export default PhysicalHealthcareProfessionalAppointment;